function params = explore_img_2channels2_41(params)
...
stack1 = double(params.data);
params = rmfield(params,'data');
stack2 = params.smooth;
params = rmfield(params,'smooth');
params.thresh.sd = std(stack1(:));

if ndims(stack1) ~= 2 || size(stack1,3) ~=1
    fprintf(['your stack size is', num2str(size(stack1)),' it should be 2D.\n']);
    return;
end
