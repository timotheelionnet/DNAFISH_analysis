function [new_ctr,ROIlimits] = compute_ROI_boundaries(stack,spot_ctr,cutwidth,thickness,ROIsize)
%stack: input image
%spot center: position of a spot in pixels


%check input consistency
if ndims(stack) == 3 && numel(spot_ctr) < 3
    dispwin('error','cannot compute ROI boundaries, incorrect ROI center coordinates');
end
