...
gen_linear_interpol_clean_small(stack,spot_ctr,cutwidth,thickness,ROIsize)
...
function  [pl, stack_bg_corr,new_ctr,ROIlimits] = ...
    ...
    [new_ctr,ROIlimits] = compute_ROI_boundaries(stack,[xc,yc,zc],[cutwidth_xy,cutwidth_z],thickness,ROIsize);
...
function  [pl, stack_bg_corr,new_ctr,ROIlimits] = ...
    ...
    [new_ctr,ROIlimits] = compute_ROI_boundaries(stack,[xc,yc],cutwidth_xy,thickness,ROIsize);
