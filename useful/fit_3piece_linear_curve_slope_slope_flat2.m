function [ x0,x1,a,b,c,d,e,chi2,xfit,yfit,Coeffsout ] = fit_3piece_linear_curve_slope_slope_flat2(x,y,sigma,varargin)
...
%OUTPUT: 
    ...
    %e  = value of the function e x>=x1
...
g = fittype( @(x0,dx,a,b,c,x) piecewise_linear3([x0,dx,a,b,c,0],x) );
...
e = piecewise_linear3([x0,x1-x0,a,b,c,0],x1);
xfit = x;
