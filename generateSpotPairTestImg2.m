function [img1,img2,spotPositions,spotSizes,spotIntensities,spotDensity,imMask] = ...
    generateSpotPairTestImg2(imSize,voxSize,nPairs,...
...
for i=1:nPairs
    ...
    % generate mask
    imMask = zeros(size(img1));
    imMask(2:end-1,2:end-1,2:end-1) = 1;
end
...
spotSize = 10* spotSize; % taking 3 times the sigma of the gaussian
