...
output = getDirectory("choose your output directory") + "/c1_max_proj/";
...
//The macro will max project Z stacks with this pre-fix
coi = "C1";
...
for (k=0; k<tmplist.length; k++) {
		...
		for (l=0; l<tmplist2.length; l++) {
			...
			if (endsWith(tmplist2[l], "/") || endsWith(tmplist2[l], "\\") ){
				...
				for (m=0; m<tmplist3.length; m++) {	
					if( ((indexOf(tmplist3[m], ".tif") != -1) || (indexOf(tmplist3[m], ".lsm") != -1) || (indexOf(tmplist3[m], ".czi") != -1))&& startsWith(tmplist3[m], coi)){
			...
			if(((indexOf(tmplist2[l], ".tif") != -1) || (indexOf(tmplist2[l], ".lsm") != -1) || (indexOf(tmplist2[l], ".czi") != -1))&& startsWith(tmplist2[l], coi)){
    ...
    if(((indexOf(tmplist[k], ".tif") != -1) || (indexOf(tmplist[k], ".lsm") != -1) || (indexOf(tmplist[k], ".czi") != -1))&& startsWith(tmplist[k], coi)){
